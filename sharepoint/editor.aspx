<%@ Page Language="C#" Inherits="System.Web.UI.Page" ResponseEncoding="utf-8" %>
<!DOCTYPE html>
<html lang="de">
<head>
    <meta charset="UTF-8">
    ...
    <title>Gebäudekarten-Designer</title>
    ...
    <style>
        ...
        /* The "Reset" export-row wrapper in the result card, and everything around it,
           is now pointless without downloads — collapse the whole export list block */
        body.sp-mode .export-list { display: none !important; }
        /* Sharing stats in the result card still useful; keep result-card visible */
        ...
        /* Role banner (for future viewer mode when redirection isn't possible) */
        body[data-role="viewer"] .pipeline-wrap::before {
            content: "Nur Lese-Modus — Bearbeitung erfordert Schreibrechte auf diese Bibliothek.";
            display: block;
            padding: 10px 16px;
            margin-bottom: 12px;
            background: #fff3cd;
...
<div class="pipeline-wrap">
    ...
    <div class="card header-card">
        <h1>Gebäudekarten-Designer</h1>
        <p>OSM-Gebäude extrahieren, 2.5D-Rendering erstellen, beschriften &mdash; direkt in SharePoint speichern.</p>
    </div>
    ...
    <div class="card">
        ...
        <div class="tab-panel" id="tabUpload">
            <div class="upload-zone" id="uploadZone">
                ...
                <span class="upload-hint">GeoJSON-Polygon oder Gebäude-Metadaten (.json)</span>
    ...
    <div class="card">
        ...
        <div class="params-section">
            ...
            <div class="params-row cols-2">
                <div class="param-group">
                    <label>Außenfarbe <span class="info-tip" tabindex="0"><span class="info-tip-text">Farbe der Gebäudeaußenseite (Dach und Wände) in der 2.5D-Ansicht.</span></span></label>
            ...
            <div class="params-row cols-2">
                ...
                <div class="param-group">
                    ...
                    <select id="paramTileProvider">
                        <option value="osm">OpenStreetMap (Referer nötig)</option>
    ...
    <div class="card">
        ...
        <div class="result-card" id="resultCard">
            ...
            <div class="button-row" style="margin-bottom:18px;">
                <button class="btn btn-success btn-sm" id="btnEditor" data-tooltip="Öffnet den Gebäude-Editor zum Bearbeiten von Namen, Gruppen, Beschreibungen und Farben.">Zum Editor</button>
    ...
    <!-- Accordion 2: Gebäude Editor -->
    <div class="accordion collapsed" id="accordionEditor">
        <div class="accordion-header" onclick="toggleAccordion('accordionEditor')">
            <h2><span class="step-badge">&#9998;</span> Gebäude Editor <span class="accordion-badge hidden" id="editorBadge"></span></h2>
            <span class="accordion-toggle">&#9660;</span>
        </div>
        <div class="accordion-body">
            <div class="editor-layout">
                <aside class="editor-sidebar">
                    <div class="editor-sidebar-header">
                        <h3>Gebäude</h3>
                        <p id="edSidebarInfo">Interaktiver Gebäude-Editor</p>
                    </div>
                    <div class="editor-toolbar">
                        <button class="btn btn-secondary btn-sm" id="edLoadBtn" data-tooltip="Lädt eine zuvor gespeicherte JSON-Datei und übernimmt Bezeichnungen, Beschreibungen und Gruppen.">Laden</button>
                        ...
                        <!-- Preview button hidden in SP mode, but present so app.js's addEventListener doesn't throw -->
                        <button class="btn btn-primary btn-sm" id="edPreviewBtn" data-tooltip="Vorschau (in SharePoint-Modus deaktiviert — nutze viewer.aspx).">Vorschau</button>
                    </div>
                    <!-- Save-submenu is unused in SP mode (edSaveBtn does direct save) but must exist for app.js bindings -->
                    <div class="editor-toolbar editor-toolbar-save hidden" id="edSaveMenu">
                        <button class="btn btn-sm" id="edSaveJson">Gebäude-<br>daten</button>
                    ...
                    <div class="editor-toolbar editor-toolbar-secondary">
                        <button class="btn btn-sm" id="edDrawAreaBtn" style="background:#2196F3;color:#fff;" data-tooltip="Zeichnet eine neue Fläche/Zone durch Klicken von Punkten auf der Karte.">&#x25A1; Fläche zeichnen</button>
                        <button class="btn btn-sm" id="edToggleAreasBtn" style="background:#90CAF9;color:#1565C0;font-size:11px;" data-tooltip="Flächen auf der Karte ein-/ausblenden.">&#x25A1; Flächen ein</button>
                    </div>
                    ...
                    <div id="edSidebarContent">
                        <div class="ed-empty-state"><p>Führen Sie zuerst die Pipeline aus, um Gebäude zu laden.</p></div>
                    </div>
                </aside>
...
<div class="viewer-overlay" id="viewerOverlay">
    <div class="vo-dialog">
        <button class="vo-close-btn" id="voCloseBtn" title="Schließen">&times;</button>
...
<div class="undo-redo-float" id="undoRedoFloat">
    <button class="undo-redo-btn" id="undoBtn" disabled data-tooltip="Rückgängig (Strg+Z)">&#x21B6;</button>
